...
class ListsSuite extends FunSuite {
  ...
  test("sum of a few numbers incl negative number") {
    assert(sum(List(1,2,-3)) === 0)
  }
  
  test("sum of a few numbers incl negative numbers") {
  ...
  test("max of a few numbers incl negative") {
  ...
  test("max of empty list throws illegal argument") {
